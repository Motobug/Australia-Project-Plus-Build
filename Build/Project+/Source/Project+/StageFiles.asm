...
########################################################
Custom Stage SD File Loader [DukeItOut, Random Alts by Kapedani]
# 
...
Multiplayer:
    ...
    ble FindParam
    subi r3, r23, Random1To1AltsStartIndex     # Get number of random alts
    lis r29, 0x8003			# \
    ori r29, r29, 0xFC7C	# | Randi seeding to get random alt slot (0-to-[val-1])
    mtctr r29				# |
    bctrl					# /
    addi r3, r3, Random1To1AltsStartIndex
    mulli r29, r3, 0x4
    b slotFound
FindParam:
...
slotFound:
    lhz r3, 0(r28)			# Get access to the stage ID
    cmpwi r3, 0x28          # Do not save if Results stage
    beq DoNotSaveASL
    addi r23, r22, 8		# \ Get to the list of inputs and title offsets
    lhzx r25, r23, r29      # /
    li r3, 11					# \
